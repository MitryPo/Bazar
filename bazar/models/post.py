...
class Post(models.Model):
    category = models.ForeignKey(Category, default='Motor', verbose_name=_("Category"), on_delete=models.CASCADE)
    ...
    city = models.ForeignKey(City, default='Penza', verbose_name=_("City"), on_delete=models.CASCADE)
